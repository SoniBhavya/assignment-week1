...
with(subset4,plot(datetime,Voltage,type="l",lwd=1,col="black",bty="l",pch=20 , cex=1))
...
with(subset4,plot(datetime,Global_reactive_power,type="l",lwd=1,col="black",bty="l",pch=20 , cex=1))
